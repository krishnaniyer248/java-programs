package datastructures_basics.unrolledlinkedlists;
...
public class UnrolledLinkedList<E> extends AbstractList<E> implements List<E>, Serializable {
    ...
    // the first and last nodes of this list
    ...
    public UnrolledLinkedList(int nodeCapacity) throws IllegalArgumentException {
        if (nodeCapacity < 8){
            throw new IllegalArgumentException("nodeCapaciy < 8");
        }
    ...
    public Object[] toArray() {
        ...
        int p = 0;
        for (ListNode node = firstNode; node != null; node = node.next) {
